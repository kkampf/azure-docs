...
> [!NOTE]
> Similiar to cluster worker nodes, edge nodes are also patch managed.  For more information, see [OS patching for HDInsight](./hdinsight-os-patching.md).
